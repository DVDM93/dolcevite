...
<body class="bodyclass">
    <div class="container-fluid bodydiv">
        <div class="card">
            ...
            <div class="imgBox">
                <img src="{{ Storage::url($specialPizza->image) }}" alt="" class="cover">
            </div>
            ...
            <h4 class="message"> <b> ladolceviteibiza </b> {{ $specialPizza->description }} <span> #ibiza #dolcevite #2023</span></h4>
