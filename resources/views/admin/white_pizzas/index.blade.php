    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-end m-2 p-2">
                <a href="{{ route('admin.white_pizzas.create') }}"
                        ...
                        @foreach ($whitePizzas as $whitePizza)
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <th scope="row"
                                    ...
                                    <img src="{{ Storage::url($whitePizza->image) }}" alt=""
                                ...
                                <th scope="row"
                                    ...
                                    <div class="flex space-x-2">
                                        <a href="{{ route('admin.white_pizzas.edit', $whitePizza->id) }}"
                                            class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-lg text-white">
                                            Modifica </a>
                                        <form class="px-4 py-2 bg-red-500 hover:bg-red-700 rounded-lg text-white"
                                            action="{{ route('admin.white_pizzas.destroy', $whitePizza->id) }}" method="POST"
