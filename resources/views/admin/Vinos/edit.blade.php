                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.vinos.update', $vino->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6 mb-2">
                            ...
                            <div class="mt-1">
                                <input type="text" id="name" name="name" value="{{ $vino->name }}"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            @enderror
                            <div class="sm:col-span-6">
                                <label for="price" class="block text-sm font-medium text-gray-700 mt-3"> Copa </label>
                                <div class="mt-1">
                                    <input type="number" min="0.00" max="10000.00" step="0.01" id="price" name="price" value="{{ $vino->copa }}"
                                        class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                @error('copa')
                                    <div class="text-sm text-red-400">{{ $message }}</div>
