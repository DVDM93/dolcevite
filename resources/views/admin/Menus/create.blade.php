                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.menus.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6 mt-4">
                            <label for="image" class="block text-sm font-bold text-gray-700"> Immagine </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 mt-4">
                            <label for="price" class="block text-sm font-bold text-gray-700"> Prezzo </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            <label for="body" class="block text-sm font-bold text-gray-700">Descrizione</label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            <label for="categories" class="block text-sm font-bold text-gray-700">Categoria</label>
                            <div class="mt-1">
                        ...
                        <div class="mt-6 p-4">
                            <button type="submit"
                                class="px-4 py-2 bg-blue-500 hover:bg-blue-700 rounded-lg text-white text-xl font-bold">Aggiungi</button>
                        </div>
                    </form>
                </div>            </div>
